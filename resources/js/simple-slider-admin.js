class SimpleSliderAdminManagement {
    init(tableId) {
        ...
        $sortButton.off('click').on('click', (event) => {
            ...
            ToxyTech.showButtonLoading(_self)
            ...
            $httpClient
                ...
                .then(({ data }) => {
                    ToxyTech.showSuccess(data.message)
                })
                .finally(() => {
                    ToxyTech.hideButtonLoading(_self)
                    _self.hide()
                })
        })
    }
        ...
        .on('show.bs.modal', '#simple-slider-item-modal', (e) => {
            ...
            $httpClient
                ...
                .then(({ data }) => {
                    ...
                    ToxyTech.initMediaIntegrate()

                    ToxyTech.initResources()
                })
        })
        ...
        .on('click', '#simple-slider-item-modal button[type="submit"]', (e) => {
            ...
            $httpClient
                ...
                .then(({ data }) => {
                    ...
                    $('#toxytech-simple-slider-tables-simple-slider-item-table').DataTable().draw()
                })
        })
})
